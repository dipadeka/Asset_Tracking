  ...
  return (
    <>
      ...
      {(row.nurseEntries || []).map((nurse, ni) => {
        // ✅ FIX: use function body so ni is safely captured in scope
        return (
          <Box
            key={ni}
            sx={{
          ...
          >
            ...
            {(row.nurseEntries || []).length > 1 && (
              <IconButton
                ...
                onClick={() => {
                  const u = [...hospitalizationRows];
                  u[index].nurseEntries = u[index].nurseEntries.filter(
                    (_, i) => i !== ni
                  );
                  setHospitalizationRows(u);
                }}
            ...
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseName = e.target.value;
                    setHospitalizationRows(u);
                  }}
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseQualification = e.target.value;
                    setHospitalizationRows(u);
                  }}
                >
                  {[
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseRegNo = e.target.value;
                    setHospitalizationRows(u);
                  }}
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  helperText={
                    nurse.nurseContact && nurse.nurseContact.length !== 10
                      ? "Must be 10 digits"
                      : ""
                  }
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseContact = e.target.value;
                    setHospitalizationRows(u);
                  }}
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseShift = e.target.value;
                    setHospitalizationRows(u);
                  }}
                >
                  {[
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField
                  ...
                  onChange={(e) => {
                    const u = [...hospitalizationRows];
                    u[index].nurseEntries[ni].nurseJoiningDate = e.target.value;
                    setHospitalizationRows(u);
                  }}
                />
              </Grid>
            </Grid>
            {/* ✅ closes Nurse Fields Grid */}
      
            {/* ── 📋 Activity Tracking Subsection ── */}
            <Box
              mt={2}
              sx={{
            ...
            >
              ...
              {(nurse.activities || []).map((act, ai) => {
                // ✅ FIX: function body so ai is safely captured in scope
                return (
                  <Box
                    key={ai}
                    sx={{
                  ...
                  >
                    ...
                    {(nurse.activities || []).length > 1 && (
                      <IconButton
                        ...
                        onClick={() => {
                          const u = [...hospitalizationRows];
                          u[index].nurseEntries[ni].activities = u[index]
                            .nurseEntries[ni].activities.filter(
                              (_, i) => i !== ai
                            );
                          setHospitalizationRows(u);
                        }}
                    ...
                    <Grid container spacing={2}>
                      <Grid item xs={12} sm={6} md={3}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const u = [...hospitalizationRows];
                            u[index].nurseEntries[ni].activities[ai].activityType =
                              e.target.value;
                            setHospitalizationRows(u);
                          }}
                        >
                      ...
                      <Grid item xs={12} sm={6} md={3}>
                        <TextField
                          ...
                          fullWidth
                          size="small"
                          value={act.activityDesc}
                          onChange={(e) => {
                            const u = [...hospitalizationRows];
                            u[index].nurseEntries[ni].activities[ai].activityDesc =
                              e.target.value;
                            setHospitalizationRows(u);
                          }}
                        />
                      ...
                      <Grid item xs={12} sm={6} md={3}>
                        <TextField
                          ...
                          size="small"
                          InputLabelProps={{ shrink: true }}
                          value={act.activityDateTime}
                          onChange={(e) => {
                            const u = [...hospitalizationRows];
                            u[index].nurseEntries[ni].activities[ai].activityDateTime =
                              e.target.value;
                            setHospitalizationRows(u);
                          }}
                        />
                      ...
                      <Grid item xs={12} sm={6} md={3}>
                        <TextField
                          ...
                          onChange={(e) => {
                            const u = [...hospitalizationRows];
                            u[index].nurseEntries[ni].activities[ai].remarks =
                              e.target.value;
                            setHospitalizationRows(u);
                          }}
                        />
                ...
                ); // ✅ closes each activity row return
              })}
              {/* ✅ closes activity .map() */}
      
              {/* Single Add Activity Button — after all activity rows */}
              <Button
                size="small"
                variant="outlined"
                startIcon={<AddCircleOutlineIcon />}
                ...
                onClick={() => {
                  const u = [...hospitalizationRows];
                  u[index].nurseEntries[ni].activities = [
                    ...(u[index].nurseEntries[ni].activities || []),
                    blankActivity(),
                  ];
                  setHospitalizationRows(u);
            ...
            {/* ✅ closes Activity Tracking subsection Box */}
      
          </Box>
        ); // ✅ closes each nurse card return
      })}
      {/* ✅ closes nurse .map() */}
