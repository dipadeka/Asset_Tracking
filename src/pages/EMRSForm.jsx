...
const thStyle = { border: '1px solid #e0e0e0', padding: '8px', textAlign: 'left', fontWeight: 600 };
...
const gemPercentage = totalProcurements > 0
...
const getAttendanceMarks = (percent) => {
  ...
  const calculateGemMarks = (percentage) => {
    ...
    if (numericPercentage === 100) { // Explicitly for 100%
      return 5;
...
const prepareAcademicResults = (results) => {
  ...
  const prepareHospitalization = (rows) => {
    return rows.map((item) => ({
      ...
      "Sickle Cell Screening Conducted": item["Sickle Cell Screening Conducted"],
    ...
    counsellorSessionsConducted: Number(item.counsellorSessionsConducted || 0),
    counsellorStudentsCounselled: Number(item.counsellorStudentsCounselled || 0),
    }));
  };
  ...
  const emrsBasicFields = [
    ...
    { name: "principalAvailable", label: "Principal Available", options: ["Yes", "No"] },
  ...
  const boysHostelFields = [
    ...
    { name: "boysNoOfCCTV", label: "No of CCTV Camera Installed", type: "number" },
  ...
  const girlsHostelFields = [
    ...
    { name: "girlsNoOfCCTV", label: "No of CCTV Camera Installed", type: "number" },
...
<Box sx={{ border: "1px solid #ffccbc", borderRadius: 2, p: 2, mb: 4, background: "#fff8f6" }}>
...
<Box sx={{ border: "1px solid #e2e8f0", borderRadius: 2, p: 3, mb: 4, background: "#fff" }}>
  <Typography sx={{ fontWeight: 600, color: "#1976d2", mb: 1.5, fontSize: 14 }}>
    🧪 Laboratory Functionality
  </Typography>
  ...
  <Grid container spacing={2}>
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Physics Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Chemistry Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Biology Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Computer Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Mathematics Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} select label="Skill Lab Functional" fullWidth size="small" sx={{ minWidth: 220 }}>
            <MenuItem value="Yes">Yes</MenuItem>
            <MenuItem value="No">No</MenuItem>
          </TextField>
        )}
    ...
    <Grid item xs={12} sm={6} md={4}>
      <Controller
        ...
        defaultValue=""
        render={({ field }) => (
          <TextField {...field} label="Marks Obtained (out of 5)" fullWidth size="small" sx={{ minWidth: 220 }} InputProps={{ readOnly: true }} />
        )}
      />
    </Grid>
  </Grid>
              ...
              <Grid container spacing={2} mb={4}>
                ...
                <Grid item xs={12} sm={4} md={4}>
                  <Controller name="boysCCTVInstalled" control={control} defaultValue=""
                    render={({ field }) => (
                      <TextField {...field} select label="CCTV  Camera Installed" fullWidth size="small" sx={{ minWidth: 220 }}>
                        <MenuItem value="Yes">Yes</MenuItem>
                        <MenuItem value="No">No</MenuItem>
                      </TextField>
                    )} />
...
<Box sx={{ border: "1px solid #e2e8f0", borderRadius: 2, p: 3, background: "#fff" }}>
  ...
  <Grid container spacing={2}>
    <Grid item xs={12} md={2}>
      <TextField select fullWidth size="small" label="Mess Year"
        value={messData.year}
        onChange={(e) => setMessData({ ...messData, year: e.target.value })}
      >
    ...
    <Grid item xs={12} md={2}>
      <TextField select fullWidth size="small" label="Mess Month"
        value={messData.month}
        onChange={(e) => setMessData({ ...messData, month: e.target.value })}
      >
    ...
    <Grid item xs={12} md={2}>
      <TextField type="date" fullWidth size="small" label="Purchase Date"
        InputLabelProps={{ shrink: true }}
        value={messData.purchaseDate}
        onChange={(e) => setMessData({ ...messData, purchaseDate: e.target.value })}
      />
    </Grid>

    <Grid item xs={12} md={3}>
      <TextField fullWidth size="small" label="Invoice/Bill No."
        value={messData.billNo}
        onChange={(e) => setMessData({ ...messData, billNo: e.target.value })}
      />
    </Grid>

    <Grid item xs={12} md={3}>
      <TextField select fullWidth size="small" sx={{ minWidth: 220 }} label="Payment Method"
        value={messData.paymentMethod}
        onChange={(e) => setMessData({ ...messData, paymentMethod: e.target.value })}
      >
    ...
    <Table size="small">
      ...
      <TableBody>
        {messData.items.map((item, index) => (
          <TableRow key={index}>
            <TableCell>
              <TextField select size="small" value={item.category}
            ...
            <TableCell>
              <Button color="error" onClick={()=>removeItem(index)}>X</Button>
            </TableCell>
          </TableRow>
        ))}
      </TableBody>
  ...
  {/* ================= SUBSECTION 2 ================= */}
  <Typography sx={{ fontWeight:600, color:"#2563eb", mt:4, mb:2 }}>
          ...
          {[
            ...
            <TableCell key={field}>
              <TextField select size="small"
                ...
                onChange={(e)=>setMessData(prev=>({...prev,[field]:e.target.value}))}
              >
                <MenuItem value="Yes">Yes</MenuItem>
                <MenuItem value="No">No</MenuItem>
              </TextField>
          ...
          <TableCell>
            <Typography sx={{ fontWeight:700 }}>
              {(() => {
                ...
                return yes===5?5:yes===4?3:yes===3?1:0;
              })()}
            </Typography>
          </TableCell>
        </TableRow>
  ...
  <Box sx={{ mt:3 }}>
    ...
    <TableContainer component={Paper}>
      <Table size="small">
        <TableBody>
          <TableRow><TableCell>All 5 fulfilled</TableCell><TableCell>5</TableCell></TableRow>
          <TableRow><TableCell>Any 4 fulfilled</TableCell><TableCell>3</TableCell></TableRow>
          <TableRow><TableCell>Any 3 fulfilled</TableCell><TableCell>1</TableCell></TableRow>
          <TableRow><TableCell>Less than 3 fulfilled</TableCell><TableCell>0</TableCell></TableRow>
        </TableBody>
      </Table>
    </TableContainer>
  </Box>
                ...
                >
                  ...
                  <Box sx={{ padding: 3 }}>
                    ...
                    <Grid container spacing={2} mb={3}>
                      ...
                      <Grid item xs={12} sm={6} md={4}>
                        <TextField label="Sanctioned Capacity" type="number" inputProps={{ min: 0 }} fullWidth size="small" value={row.sanctionedCapacity}
                          onChange={(e) => { const u = [...enrollmentRows]; u[rowIndex].sanctionedCapacity = e.target.value; setEnrollmentRows(u); }} />
                      </Grid>
                      <Grid item xs={12} sm={6} md={4}>
                        <TextField label="Current Enrollment" type="number" inputProps={{ min: 0 }} fullWidth size="small" value={row.currentEnrollment}
...
<Grid item xs={12}>
  ...
  background: cat.notApplicable ? "#f5f5f5" : "#fff"
}}>

  {/* Header */}
  <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 1.5 }}>
    <Box sx={{ width: 10, height: 10, borderRadius: "50%",
      background: cat.notApplicable ? "#bdbdbd" : cat.color }} />
    <Typography sx={{ fontSize: 13, fontWeight: 700,
      color: cat.notApplicable ? "#9e9e9e" : cat.color }}>
      {cat.label}
    </Typography>
    ...
    {cat.notApplicable && (
      <Box sx={{
        ml: "auto", px: 1, py: 0.2,
        background: "#eeeeee", borderRadius: 1,
        border: "1px solid #bdbdbd"
      }}>
        <Typography sx={{ fontSize: 10, fontWeight: 700, color: "#757575" }}>
          N/A — Not applicable in Assam
        </Typography>
      </Box>
    )}
  </Box>
      ...
      <Grid item xs={4} key={level}>
        <TextField
          ...
          helperText={
            cat.notApplicable
              ? "Not applicable"
              : level === "State" && !cat.hasState
                ? "0 (N/A)"
                : `Expected: ${cat.expected[level]}`
          }
          onChange={(e) => {
            if (cat.notApplicable) return; // guard
            handleChange(cat.key, level, e.target.value);
          }}
        />
      </Grid>
    ))}
  ...
  {!cat.notApplicable && rowTotal > 0 && (
    <Typography sx={{ fontSize: 11, mt: 1, fontWeight: 600,
      color: seatsOk ? "#2e7d32" : "#e65100" }}>
      {seatsOk
        ...
        : `⚠️ Expected B:${cat.expected.Block} D:${cat.expected.District} S:${cat.expected.State} · Got B:${block} D:${district} S:${state}`}
            ...
            <Grid item xs={12}>
              <Box sx={{ border: "1px dashed #e65100", borderRadius: 2, p: 1.5, background: "#fff3e0" }}>
                    ...
                    return (
                      <Grid item xs={12} md={4} key={cat.key}>
                        <Box sx={{ background: "#fff", borderRadius: 1.5, p: 1.5, border: "1px solid #ffe0b2" }}>
                          <Typography sx={{ fontSize: 12, fontWeight: 600, color: "#e65100", mb: 1 }}>
                ...
                {/* Cat IV pool check */}
                {(() => {
                  const cat4Total = ["LWE_Covid", "Widow", "Divyang"]
                    .reduce((sum, k) => sum + levels.reduce((s, l) => s + Number(breakdown[k]?.[l] || 0), 0), 0);
                  const cat4Max = Math.round((row.sanctionedCapacity || 60) * 0.07);
                  if (cat4Total === 0) return null;
                  return (
                    <Typography sx={{ fontSize: 11, fontWeight: 600, mt: 1.5,
                      color: cat4Total > cat4Max ? "#c62828" : "#2e7d32" }}>
                      {cat4Total > cat4Max
                  ...
                  return (
                    <Box key={key} sx={{ display: "flex", alignItems: "center", gap: 0.8 }}>
                      ...
                      <Typography sx={{ fontSize: 12, color: "#374151" }}>
                        {categoryLabels[i]}: <strong>{val}</strong>
                      </Typography>
                    </Box>
                  );
                })}
  ...
  <Grid item xs={12} sm={6} md={4}>
    <TextField
      ...
      onChange={(e) => {
        ...
        u[rowIndex].marks = getMarksFromPercentage(Number(passPercent)); // ✅ fixed
        setEnrollmentRows(u);
      }}
    />
  </Grid>
        ...
        <TextField
          ...
          onChange={(e) => {
            ...
            updatedRows[rowIndex] = {
              ...updatedRows[rowIndex],
              competitiveExam: {
                ...(updatedRows[rowIndex].competitiveExam || {}),
...
{extraCurricularRows.map((row, index) => (
    ...
    <Grid container spacing={2}>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          ...
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].academicYear = e.target.value; setExtraCurricularRows(u); }}
        >
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          ...
          value={row.class}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].class = e.target.value; setExtraCurricularRows(u); }}
        >
          {["6","7","8","9","10","11","12"].map(c => <MenuItem key={c} value={c}>{c}</MenuItem>)}
        </TextField>
      </Grid>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          ...
          value={row.section}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].section = e.target.value; setExtraCurricularRows(u); }}
        >
          {["A","B","C"].map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
        </TextField>
      </Grid>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          label="Name of the Program" fullWidth size="small"
          value={row.initiativeName}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].initiativeName = e.target.value; setExtraCurricularRows(u); }}
        />
      </Grid>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          label="Collaborating Partner" fullWidth size="small"
          value={row.collaboratingPartner}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].collaboratingPartner = e.target.value; setExtraCurricularRows(u); }}
        />
      </Grid>
  ...
  <Grid container spacing={1}>
    ...
    <Grid item xs={row.areasOfDevelopment === "Others" ? 6 : 12}>
      ...
      >
        {[
          "Sports","Culture","Health & Wellness","Value Education","Kaushalya Skill Internship",
          "Computer Skills","Personality Development","Excursions","Career Guidance","Exposure",
          "Competitive Exam Training","Enhancing Learning Skills","Adventure Activities",
          "STEM Learning","Innovation","Others"
        ].map(area => (
    ...
    {row.areasOfDevelopment === "Others" && (
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          label="Description / Objectives" fullWidth size="small"
          value={row.description}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].description = e.target.value; setExtraCurricularRows(u); }}
        />
      </Grid>
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField
          select label="Status" fullWidth size="small" sx={{ minWidth: 220 }}
          value={row.status}
          onChange={(e) => { const u = [...extraCurricularRows]; u[index].status = e.target.value; setExtraCurricularRows(u); }}
        >
  ...
  <Grid item xs={12}>
    <Box sx={{ border: "1.5px solid #1a56a0", borderRadius: 0, overflow: "hidden" }}>
      <Box sx={{ background: "#1a56a0", px: 2, py: 0.9 }}>
        <Typography sx={{ color: "#fff", fontSize: "0.72rem", fontWeight: 500,
      ...
      <Box sx={{ p: 2, display: "flex", flexWrap: "wrap", gap: 2, background: "#fff" }}>
        ...
        {watch("studentsParticipatedCulturalMeet") === "Yes" && (
          <Box sx={{ flex: "1 1 160px" }}>
            <Controller name="studentsParticipatedCount" control={control} defaultValue=""
              render={({ field }) => (
                <TextField {...field} label="No. of Students" type="number"
        ...
        {/* Marks Obtained */}
        <Box sx={{ flex: "1 1 160px", display: "flex", alignItems: "center",
          background: "#f7faff", border: "1px solid #c8d4e8", borderRadius: 1, px: 2, py: 1, gap: 2 }}>
          <Typography sx={{ fontSize: "0.72rem", color: "#5a6a85", fontWeight: 500,
          ...
          {(() => {
            ...
            return (
              <Typography sx={{ fontSize: "1.2rem", fontWeight: 500, ml: "auto",
    ...
    <Box sx={{ border: "1.5px solid #1a56a0", borderRadius: 0, overflow: "hidden" }}>
      ...
      <Box sx={{ p: 2, display: "flex", flexWrap: "wrap", gap: 2, background: "#fff" }}>
        ...
        {watch("nccUnitRunning") === "Yes" && (
          <Box sx={{ flex: "1 1 160px" }}>
            <Controller name="nccStudentsCount" control={control} defaultValue=""
              render={({ field }) => (
                <TextField {...field} label="No. of NCC Students" type="number"
                  fullWidth size="small" inputProps={{ min: 0 }} />
              )} />
          </Box>
        )}
        ...
        <Box sx={{ flex: "1 1 160px", display: "flex", alignItems: "center",
          ...
          {(() => {
            const yes = [watch("nccUnitRunning"), watch("scoutGuideRunning")]
              .filter(v => v === "Yes").length;
    ...
    <Box sx={{ border: "1.5px solid #1a56a0", borderRadius: 0, overflow: "hidden" }}>
      ...
      <Box sx={{ p: 2, display: "flex", flexWrap: "wrap", gap: 2, background: "#fff" }}>
        ...
        <Box sx={{ flex: "1 1 160px", display: "flex", alignItems: "center",
          ...
          {(() => {
            const yes = [watch("studentsSelectedRBVP"), watch("studentsSelectedInspireManak")]
              .filter(v => v === "Yes").length;
            const val = yes === 2 ? 5 : yes === 1 ? 3 : 0;
            return (
              <Typography sx={{ fontSize: "1.2rem", fontWeight: 500, ml: "auto",
...
<Grid container spacing={2} mb={4}>
  <Grid item xs={12}>
    <Box sx={{ border: "1.5px solid #1a56a0", borderRadius: 0, overflow: "hidden", maxWidth: 440 }}>
      <Box sx={{ background: "#1a56a0", px: 2, py: 0.8, display: "flex", justifyContent: "space-between" }}>
        <Typography sx={{ color: "#fff", fontSize: "0.68rem", fontWeight: 500,
          textTransform: "uppercase", letterSpacing: "0.5px" }}>
          *Marking Criteria for Points 2, 3 and 4
        </Typography>
        <Typography sx={{ color: "#fff", fontSize: "0.68rem", opacity: 0.85 }}>Out of 5</Typography>
      </Box>
      <Table size="small" sx={{ tableLayout: "fixed" }}>
        <TableHead>
          <TableRow sx={{ background: "#e8f0fb" }}>
            {["Participation", "Marks"].map(h => (
              <TableCell key={h} sx={{ fontWeight: 500, fontSize: "0.68rem", textTransform: "uppercase",
                letterSpacing: "0.3px", color: "#0c447c", borderBottom: "1.5px solid #1a56a0", py: 0.8 }}>
                {h}
              </TableCell>
            ))}
          </TableRow>
        ...
        <TableBody>
          {[
            { status: "Both YES", marks: 5, bg: "#d4edda", color: "#155724", border: "#b8dfc4" },
            { status: "One YES",  marks: 3, bg: "#fff3cd", color: "#856404", border: "#f0d78c" },
            { status: "Both NO",  marks: 0, bg: "#f8d7da", color: "#721c24", border: "#f0b8bd" },
          ].map((r, i) => (
            <TableRow key={i} sx={{ background: i % 2 === 0 ? "#f7faff" : "#fff",
              "&:last-child td": { borderBottom: 0 } }}>
              <TableCell sx={{ fontSize: "0.8rem", color: "#1a1a2e", py: 0.9 }}>{r.status}</TableCell>
              <TableCell sx={{ py: 0.9 }}>
                <Box sx={{ display: "inline-block", px: 1.5, py: 0.2, borderRadius: "3px",
                  fontSize: "0.75rem", fontWeight: 500, minWidth: 28, textAlign: "center",
      ...
      <Box sx={{ background: "#e8f0fb", borderTop: "1px solid #c8d4e8", px: 2, py: 0.6, textAlign: "right" }}>
        <Typography sx={{ fontSize: "0.68rem", color: "#0c447c" }}>Total: out of 5 marks each</Typography>
      </Box>
    </Box>
  </Grid>
</Grid>
...
<Box mb={4}>
  <Button
    variant="outlined"
    onClick={() => setExtraCurricularRows([
      ...extraCurricularRows,
      { academicYear: "", initiativeName: "", collaboratingPartner: "",
        areasOfDevelopment: "", description: "", targetStudents: "", status: "" }
    ])}
  >
    + Add Activity
  </Button>
  ...
  >
    ...
    <Grid container spacing={2} mb={2}>
      ...
      <Grid item xs={12} sm={6} md={4}>
        ...
        >
          {[
            "General Medicine","General Surgery","Ophthalmology (Eyes)",
            "ENT (Ear, Nose & Throat)","Orthopaedics","Paediatrics",
            "Dermatology (Skin)","Dental","Gynaecology","Cardiology",
            "Neurology","Psychiatry / Mental Health","Pulmonology (Lungs)",
            "Gastroenterology","Nephrology (Kidney)","Urology",
            "Oncology (Cancer)","Endocrinology","Haematology (Blood)",
            "Emergency / Trauma","Physiotherapy","Radiology / Imaging",
            "Pathology / Lab","Other",
          ].map((dept) => (
    ...
    <Grid container spacing={2} mb={2}>
      ...
      <Grid item xs={12} sm={6} md={3}>
        <TextField label="Roll No" fullWidth size="small"
          value={row.rollNo}
      ...
      <Grid item xs={12} sm={6} md={3}>
        <TextField
          label="Guardian Contact" fullWidth size="small"
    ...
    <Grid container spacing={2} mb={2}>
      <Grid item xs={12} sm={6} md={4}>
        <TextField label="Date of Admission" fullWidth size="small" type="date"
          InputLabelProps={{ shrink: true }} value={row.admissionDate}
          onChange={(e) => { const u=[...hospitalizationRows]; u[index].admissionDate=e.target.value; setHospitalizationRows(u); }}
        />
      </Grid>
      <Grid item xs={12} sm={6} md={4}>
        <TextField label="Date of Discharge" fullWidth size="small" type="date"
          InputLabelProps={{ shrink: true }} value={row.dischargeDate}
          onChange={(e) => { const u=[...hospitalizationRows]; u[index].dischargeDate=e.target.value; setHospitalizationRows(u); }}
        />
      </Grid>
      <Grid item xs={12}>
        <TextField label="Reason for Hospitalization" fullWidth size="small" multiline rows={3}
    ...
    <Grid container spacing={2} mb={3}>
      <Grid item xs={12} sm={6} md={4}>
        <TextField label="Estimated Cost (₹)" fullWidth size="small" type="number"
          value={row.estimatedCost} inputProps={{ min: 0 }}
          onKeyDown={(e) => { if (e.key==="-"||e.key==="e") e.preventDefault(); }}
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField label="Amount Claimed (₹)" fullWidth size="small" type="number"
          value={row.amountClaimed} inputProps={{ min: 0 }}
          onKeyDown={(e) => { if (e.key==="-"||e.key==="e") e.preventDefault(); }}
      ...
      <Grid item xs={12} sm={6} md={4}>
        <TextField select label="Claim Status" fullWidth size="small" sx={{ minWidth: 220 }}
...
<Box mb={4}>
  <Button
    variant="outlined"
    onClick={() => setHospitalizationRows([...hospitalizationRows, emptyHospitalizationRow()])}
  >
      ...
      <Box sx={{ p: 2.5, display: "flex", gap: 3, flexWrap: "wrap" }}>
        ...
        <Box sx={{ flex: 1, minWidth: 260, display: "flex", flexDirection: "column", gap: 1.5 }}>
          {[
            ...
            <TextField key={idx} select fullWidth size="small" label={label}
              value={row[label] || ""}
              onChange={(e) => {
                const u = [...hospitalizationRows];
          ...
          <Box sx={{ display:"flex", alignItems:"center", justifyContent:"space-between",
            background:"#f7faff", border:"1px solid #c8d4e8", borderRadius:1.5, px:2, py:1.2 }}>
            <Typography sx={{ fontSize:"0.72rem", color:"#5a6a85", fontWeight:500,
              textTransform:"uppercase", letterSpacing:"0.4px" }}>
              Marks Obtained (out of 9)
            </Typography>
            <Typography sx={{ fontSize:"1.4rem", fontWeight:500,
              color: row.marksHealth===9?"#b8860b":row.marksHealth===7?"#155724":row.marksHealth===5?"#856404":row.marksHealth===3?"#7d3c0c":row.marksHealth===0?"#721c24":"#1a1a2e" }}>
        ...
        <Box sx={{ minWidth:300, flex:"0 0 340px", border:"1.5px solid #1a56a0", borderRadius:1.5, overflow:"hidden" }}>
          ...
          {[
            ...
            <Box key={r.status} sx={{ display:"flex", alignItems:"center", justifyContent:"space-between",
              px:2, py:1, borderTop:"0.5px solid #dce3f0",
              borderLeft: row.marksHealth===r.marks?"3px solid #1a56a0":"3px solid transparent",
              background: row.marksHealth===r.marks?"#e8f0fb":i%2===0?"#f7faff":"#fff" }}>
              <Typography sx={{ fontSize:"0.8rem", color:"#1a1a2e" }}>{r.status}</Typography>
              <Box sx={{ background:r.bg, color:r.color, border:`0.5px solid ${r.border}`,
                borderRadius:"3px", px:1.5, py:0.2, fontSize:"0.75rem", fontWeight:500,
                minWidth:28, textAlign:"center" }}>{r.marks}</Box>
            </Box>
          ))}
...
<LocalizationProvider dateAdapter={AdapterDayjs}>
  <Box sx={{ display: "flex", flexDirection: "column", gap: 1.5, mb: 3 }}>
    ...
    {/* Eye Header */}
    <Typography sx={{ fontSize: "0.72rem", fontWeight: 600, color: "#1a56a0",
      textTransform: "uppercase", letterSpacing: "0.4px",
      borderBottom: "1px solid #c8d4e8", pb: 0.5 }}>
      👁 Eye Health Details
    </Typography>

    {(row.eyeEntries || []).map((eye, ei) => (
      <Box key={ei} sx={{ border: "1px solid #e3eaf5", borderRadius: 1.5, p: 2,
        background: "#f7faff", position: "relative" }}>

        {(row.eyeEntries || []).length > 0 && (
          <IconButton size="small"
            sx={{ position: "absolute", top: 6, right: 6, color: "#c62828" }}
            onClick={() => {
              const u = [...hospitalizationRows];
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={4}>
            <TextField label="Eye Specialist Name" fullWidth size="small"
              value={eye.eyeSpecialistName || ""}
              onKeyDown={(e) => { if (/[0-9]/.test(e.key)) e.preventDefault(); }}
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].eyeEntries[ei].eyeSpecialistName = e.target.value;
                setHospitalizationRows(u);
              }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <DesktopDatePicker
              ...
              value={eye.eyeCheckupDate ? dayjs(eye.eyeCheckupDate) : null}
              format="DD/MM/YYYY"
              onChange={(newVal) => {
                ...
                const error = formatted
                  ? validateBiAnnualDate(formatted, u[index].eyeEntries, ei, "eyeCheckupDate")
                  : null;

                if (error) {
                  setEyeDateErrors(prev => ({ ...prev, [errKey]: error }));
              ...
              slotProps={{
                textField: {
                  ...
                  helperText: eyeDateErrors[`${index}-${ei}`]
                    ? `⚠️ ${eyeDateErrors[`${index}-${ei}`]}`
                    : "Must be 6+ months from other entries",
                  FormHelperTextProps: {
                    sx: { color: eyeDateErrors[`${index}-${ei}`] ? "#c62828" : "#888", fontSize: "0.68rem" }
                  }
                }
              }}
            />
          ...
          <Grid item xs={6} sm={3} md={2}>
            <TextField select label="Class" fullWidth size="small" sx={{ minWidth: 220 }}
              ...
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].eyeEntries[ei].eyeClass = e.target.value;
                setHospitalizationRows(u);
              }}>
              {["6","7","8","9","10","11","12"].map(c => <MenuItem key={c} value={c}>{c}</MenuItem>)}
            </TextField>
          ...
          <Grid item xs={6} sm={3} md={2}>
            <TextField select label="Section" fullWidth size="small" sx={{ minWidth: 220 }}
              ...
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].eyeEntries[ei].eyeSection = e.target.value;
                setHospitalizationRows(u);
              }}>
              {["A","B","C"].map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
            </TextField>
          ...
          {[
            ...
            { label: "No. of Students Needing Spectacle", field: "eyeNeedsSpectacle" },
            { label: "No. Needing Higher Investigation/Treatment", field: "eyeNeedsHigherInvestigation" },
          ].map(({ label, field }) => (
            <Grid item xs={12} sm={6} md={3} key={field}>
              <TextField label={label} fullWidth size="small" type="number" inputProps={{ min: 0 }}
                ...
                onChange={(e) => {
                  if (Number(e.target.value) >= 0) {
                    const u = [...hospitalizationRows];
                    u[index].eyeEntries[ei][field] = e.target.value;
                    setHospitalizationRows(u);
                  }
                }}
              />
    ...
    <Typography sx={{ fontSize: "0.72rem", fontWeight: 600, color: "#1a56a0",
      textTransform: "uppercase", letterSpacing: "0.4px",
      borderBottom: "1px solid #c8d4e8", pb: 0.5, mt: 1 }}>
      👂 Ear Health Details
    </Typography>

    {(row.earEntries || []).map((ear, eri) => (
      <Box key={eri} sx={{ border: "1px solid #e3eaf5", borderRadius: 1.5, p: 2,
        background: "#f7faff", position: "relative" }}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} sm={6} md={4}>
            <TextField label="Ear Specialist Name" fullWidth size="small"
              value={ear.earSpecialistName || ""}
              onKeyDown={(e) => { if (/[0-9]/.test(e.key)) e.preventDefault(); }}
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].earEntries[eri].earSpecialistName = e.target.value;
                setHospitalizationRows(u);
              }}
            />
          </Grid>
          ...
          <Grid item xs={12} sm={6} md={4}>
            <DesktopDatePicker
              label="Checkup Date (Bi-Annual)"
              value={ear.earCheckupDate ? dayjs(ear.earCheckupDate) : null}
              format="DD/MM/YYYY"
              onChange={(newVal) => {
                const formatted = newVal && newVal.isValid() ? newVal.format("YYYY-MM-DD") : "";
                const u = [...hospitalizationRows];
                ...
                const error = formatted
                  ? validateBiAnnualDate(formatted, u[index].earEntries, eri, "earCheckupDate")
                  : null;

                if (error) {
                  setEarDateErrors(prev => ({ ...prev, [errKey]: error }));
              ...
              slotProps={{
                textField: {
                  ...
                  helperText: earDateErrors[`${index}-${eri}`]
                    ? `⚠️ ${earDateErrors[`${index}-${eri}`]}`
                    : "Must be 6+ months from other entries",
                  FormHelperTextProps: {
                    sx: { color: earDateErrors[`${index}-${eri}`] ? "#c62828" : "#888", fontSize: "0.68rem" }
                  }
                }
              }}
            />
          ...
          <Grid item xs={6} sm={3} md={2}>
            <TextField select label="Class" fullWidth size="small" sx={{ minWidth: 220 }}
              ...
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].earEntries[eri].earClass = e.target.value;
                setHospitalizationRows(u);
              }}>
              {["6","7","8","9","10","11","12"].map(c => <MenuItem key={c} value={c}>{c}</MenuItem>)}
            </TextField>
          ...
          <Grid item xs={6} sm={3} md={2}>
            <TextField select label="Section" fullWidth size="small" sx={{ minWidth: 220 }}
              ...
              onChange={(e) => {
                const u = [...hospitalizationRows];
                u[index].earEntries[eri].earSection = e.target.value;
                setHospitalizationRows(u);
              }}>
              {["A","B","C"].map(s => <MenuItem key={s} value={s}>{s}</MenuItem>)}
            </TextField>
          ...
          {[
            ...
            { label: "No. of Students Needing Ear Equipment", field: "earNeedsEquipment" },
          ].map(({ label, field }) => (
            <Grid item xs={12} sm={6} md={4} key={field}>
              <TextField label={label} fullWidth size="small" type="number" inputProps={{ min: 0 }}
                ...
                onChange={(e) => {
                  if (Number(e.target.value) >= 0) {
                    const u = [...hospitalizationRows];
                    u[index].earEntries[eri][field] = e.target.value;
                    setHospitalizationRows(u);
                  }
                }}
              />
      ...
      <Box sx={{ p:2.5, display:"flex", flexDirection:"column", gap:3 }}>
        ...
        <Box>
          <Box sx={{ display:"flex", alignItems:"center", justifyContent:"space-between", mb:1.5 }}>
            <Typography sx={{ fontSize:"0.78rem", fontWeight:600, color:"#0d47a1",
              textTransform:"uppercase", letterSpacing:"0.5px",
              borderLeft:"3px solid #1976d2", pl:1 }}>
            ...
            <Button size="small" variant="outlined"
              ...
              onClick={() => {
                const u=[...hospitalizationRows];
                u[index].nurseEntries=[...(u[index].nurseEntries||[]), blankNurseEntry()];
                setHospitalizationRows(u);
              }}>
              Add Nurse
            </Button>
          ...
          {(row.nurseEntries || []).map((nurse, ni) => (
            <Box key={ni} sx={{ border:"1px solid #e3eaf5", borderRadius:1.5, p:2, mb:1.5,
              background:"#f7faff", position:"relative" }}>
              {(row.nurseEntries||[]).length > 1 && (
                <IconButton size="small"
                  ...
                  onClick={() => {
                    const u=[...hospitalizationRows];
                    u[index].nurseEntries=u[index].nurseEntries.filter((_,i)=>i!==ni);
                    setHospitalizationRows(u);
                  }}>
                  <DeleteOutlineIcon fontSize="small" />
                </IconButton>
              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={6} md={4}>
                  <TextField label="Nurse Full Name" fullWidth size="small"
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <TextField select label="Qualification" fullWidth size="small"  sx={{ minWidth: 220 }}
                    ...
                    {["GNM (General Nursing & Midwifery)","ANM (Auxiliary Nurse Midwife)",
                      "B.Sc Nursing","M.Sc Nursing","Post Basic B.Sc Nursing","Other"]
                      .map((q)=><MenuItem key={q} value={q}>{q}</MenuItem>)}
                  </TextField>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <TextField label="Nursing Council Reg. No." fullWidth size="small"
                    value={nurse.nurseRegNo}
                    onChange={(e)=>{ const u=[...hospitalizationRows]; u[index].nurseEntries[ni].nurseRegNo=e.target.value; setHospitalizationRows(u); }}
                  />
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <TextField label="Contact Number" fullWidth size="small"  sx={{ minWidth: 220 }}
                ...
                <Grid item xs={12} sm={6} md={4}>
                  <TextField select label="Duty Shift" fullWidth size="small"  sx={{ minWidth: 220 }}
                    value={nurse.nurseShift}
                    onChange={(e)=>{ const u=[...hospitalizationRows]; u[index].nurseEntries[ni].nurseShift=e.target.value; setHospitalizationRows(u); }}>
                    {["Morning (6 AM – 2 PM)","Evening (2 PM – 10 PM)",
                      "Night (10 PM – 6 AM)","General (Full Day)"]
                      .map((s)=><MenuItem key={s} value={s}>{s}</MenuItem>)}
                  </TextField>
                </Grid>
                <Grid item xs={12} sm={6} md={4}>
                  <TextField label="Date of Joining" fullWidth size="small" type="date"
                    InputLabelProps={{shrink:true}} value={nurse.nurseJoiningDate}
        ...
        <Box>
          <Typography sx={{ fontSize:"0.78rem", fontWeight:600, color:"#0d47a1",
            textTransform:"uppercase", letterSpacing:"0.5px",
            borderLeft:"3px solid #1976d2", pl:1, mb:1.5 }}>
            👨‍⚕️ Daily Visiting Doctor
          </Typography>

          {/* Doctor Profile */}
          <Box sx={{ border:"1px solid #e3eaf5", borderRadius:1.5, p:2, mb:2, background:"#f7faff" }}>
            <Typography sx={{ fontSize:"0.7rem", color:"#5a6a85", fontWeight:500, mb:1.5, textTransform:"uppercase" }}>
              Doctor Profile
            </Typography>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Doctor Full Name" fullWidth size="small"
                  onKeyDown={(e)=>{if(/[0-9]/.test(e.key))e.preventDefault();}}
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField select label="Specialization" fullWidth size="small"  sx={{ minWidth: 220 }}
                  ...
                  {["General Medicine / MBBS","Paediatrics","General Surgery","Gynaecology",
                    "Orthopaedics","Dermatology","ENT","Ophthalmology","Other"]
                    .map((s)=><MenuItem key={s} value={s}>{s}</MenuItem>)}
                </TextField>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Medical Council Reg. No." fullWidth size="small"
                  value={row.visitingDoctorRegNo||""}
                  onChange={(e)=>{ const u=[...hospitalizationRows]; u[index].visitingDoctorRegNo=e.target.value; setHospitalizationRows(u); }}
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Scheduled Daily Visit Time" fullWidth size="small" type="time"
                  InputLabelProps={{shrink:true}} value={row.scheduledVisitTime||""}
                  onChange={(e)=>{ const u=[...hospitalizationRows]; u[index].scheduledVisitTime=e.target.value; setHospitalizationRows(u); }}
                />
              </Grid>
            </Grid>
          </Box>
          ...
          <Box sx={{ border:"1px solid #dce3f0", borderRadius:1.5, overflow:"hidden" }}>
            <Box sx={{ background:"#1a56a0", px:2, py:1,
              ...
              <Button size="small" variant="outlined"
                startIcon={<AddCircleOutlineIcon />}
                sx={{ color:"#fff", borderColor:"rgba(255,255,255,0.5)", fontSize:"0.68rem" }}
                onClick={() => {
                  const u=[...hospitalizationRows];
                  u[index].doctorVisitLogs=[...(u[index].doctorVisitLogs||[]), blankVisitLog()];
                  setHospitalizationRows(u);
                }}>
                Add Record
              </Button>
            ...
            <TableContainer component={Paper} elevation={0}>
              <Table size="small">
                <TableHead>
                  <TableRow sx={{ background:"#e8f0fb" }}>
                    {["Visit Date","Actual Visit Time","Visit Status","Remarks / Notes",""].map((h)=>(
                      <TableCell key={h} sx={{ fontSize:"0.7rem", fontWeight:600,
                        color:"#1a56a0", textTransform:"uppercase", letterSpacing:"0.3px" }}>
                        {h}
                      </TableCell>
                    ))}
                  </TableRow>
                    ...
                    <TableRow key={li} sx={{ "&:hover":{ background:"#f7faff" } }}>
                      ...
                      <TableCell sx={{ minWidth:130 }}>
                        <TextField size="small" type="time" InputLabelProps={{shrink:true}}
                          ...
                          onChange={(e)=>{ const u=[...hospitalizationRows]; u[index].doctorVisitLogs[li].actualVisitTime=e.target.value; setHospitalizationRows(u); }}
                          sx={{ "& .MuiInputBase-root":{ fontSize:"0.78rem" } }}
                        />
                      </TableCell>
                      <TableCell sx={{ minWidth:200 }}>
                        <TextField select size="small" fullWidth
                          ...
                          sx={{ "& .MuiInputBase-root":{ fontSize:"0.78rem" } }}>
                          {[
                            {label:"Visited",       bg:"#d4edda", color:"#155724"},
                            {label:"Absent",         bg:"#f8d7da", color:"#721c24"},
                            {label:"Rescheduled",    bg:"#fff3cd", color:"#856404"},
                            {label:"Emergency Call", bg:"#cce5ff", color:"#004085"},
                            {label:"Early Departure",bg:"#e2e3e5", color:"#383d41"},
                          ].map(({label,bg,color})=>(
                            <MenuItem key={label} value={label}>
                              <Chip label={label} size="small"
                                sx={{ fontSize:"0.68rem", background:bg, color }} />
                            </MenuItem>
                          ))}
                        </TextField>
                      </TableCell>
                      <TableCell sx={{ minWidth:200 }}>
                        <TextField size="small" fullWidth placeholder="Optional remarks…"
                          value={log.remarks}
                      ...
                      <TableCell>
                        {(row.doctorVisitLogs||[]).length > 1 && (
                          <IconButton size="small" sx={{ color:"#c62828" }}
                            onClick={() => {
                              const u=[...hospitalizationRows];
                              u[index].doctorVisitLogs=u[index].doctorVisitLogs.filter((_,i)=>i!==li);
                              setHospitalizationRows(u);
                            }}>
                            <DeleteOutlineIcon fontSize="small" />
                          </IconButton>
        ...
        <Box>
          ...
          <Box sx={{ border:"1px solid #e3eaf5", borderRadius:1.5, p:2, background:"#f7faff" }}>
            <Grid container spacing={2}>
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Counsellor Full Name" fullWidth size="small"
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField select label="Qualification" fullWidth size="small"  sx={{ minWidth: 220 }}
                  ...
                  {["M.A. Psychology","M.Sc. Psychology","M.Phil. Clinical Psychology",
                    "Ph.D. Psychology","RCI Registered Counsellor","REBT / CBT Certified","Other"]
                    .map((q)=><MenuItem key={q} value={q}>{q}</MenuItem>)}
                </TextField>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Registration / Certificate No." fullWidth size="small"
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField select label="Session Type" fullWidth size="small"  sx={{ minWidth: 220 }}
                  ...
                  {["Individual","Group","Both Individual & Group"].map((t)=>(
                    <MenuItem key={t} value={t}>{t}</MenuItem>
                  ))}
                </TextField>
              </Grid>
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Sessions Conducted (This Month)"
              ...
              <Grid item xs={12} sm={6} md={4}>
                <TextField label="Students Counselled (This Month)"
                  fullWidth size="small" type="number" inputProps={{min:0}}
                  onKeyDown={(e)=>{if(e.key==="-"||e.key==="e")e.preventDefault();}}
...
<Box sx={{ border: "1px solid #e2e8f0", p: 2, borderRadius: 2, mb: 3 }}>
  <Grid container spacing={2}>
    {/* Class */}
    <Grid item xs={12} md={3}>
      <TextField select fullWidth size="small" sx={{ minWidth: 220 }} label="Class"
        value={selectedClass}
    ...
    {/* Section */}
    <Grid item xs={12} md={3}>
      <TextField select fullWidth size="small" sx={{ minWidth: 220 }} label="Section"
    ...
    {/* Month */}
    <Grid item xs={12} md={3}>
      <TextField type="month" fullWidth size="small" label="Month"
        InputLabelProps={{ shrink: true }}
        value={selectedMonth}
  ...
  {/* Monthly Attendance */}
  <Typography variant="subtitle1" sx={{ fontWeight: 600, color: "#1976d2", mt: 2, mb: 1 }}>
    Monthly Attendance
  </Typography>
            ...
            <Box key={aIdx} sx={{
              ...
              <Box sx={{ position: "absolute", top: 8, right: 8 }}>
                <Button size="small" color="error" variant="outlined"
                  ...
                  onClick={() =>
                    setMonthlyAttendance((prev) => prev.filter((_, i) => i !== aIdx))
                  }>
                  ✕
                </Button>
              </Box>
              ...
              <Grid container spacing={2} alignItems="center">
                ...
                {/* Month dropdown */}
                <Grid item xs={12} sm={6} md={3}>
                  <TextField select label="Month" fullWidth size="small" sx={{ minWidth: 220 }}
                    value={att.month}
                    onChange={(e) => updateAtt("month", e.target.value)}>
                    {["April","May","June","July","August","September",
                      "October","November","December","January","February","March"].map(m => (
                      <MenuItem key={m} value={m}>{m}</MenuItem>
                    ))}
...
<Grid item xs={6} sm={4} md={1.5}>
  <TextField label="Total Students" type="number" fullWidth size="small"
    value={att.totalStudents}
    inputProps={{ min: 0 }}
    onChange={(e) => {
      const val = Number(e.target.value);
      if (val < 0) return;
      updateAtt("totalStudents", e.target.value);
    }} />
</Grid>

{/* Working Days */}
<Grid item xs={12} sm={6} md={2}>
  <TextField label="Working Days" type="number" fullWidth size="small" 
    value={att.workingDays}
    inputProps={{ min: 0, max: 31 }}
    onChange={(e) => {
      const val = Number(e.target.value);
...
<Grid item xs={6} sm={4} md={1.5}>
  <TextField label="Days Present" type="number" fullWidth size="small"
...
<Grid item xs={6} sm={4} md={1.5}>
  <TextField label="Avg Present/Day" fullWidth size="small"
    value={avgPresent !== null ? avgPresent : ""}
    InputProps={{
      readOnly: true,
      sx: {
        background: "#f0fdf4",
...
<Grid item xs={6} sm={4} md={1.5}>
  <TextField label="Avg Absent/Day" fullWidth size="small"
    value={avgAbsent !== null ? avgAbsent : ""}
    InputProps={{
      readOnly: true,
      sx: {
        background: avgAbsent > 0 ? "#fef2f2" : "#f0fdf4",
        color: avgAbsent > 0 ? "#991b1b" : "#166534",
        fontWeight: 700,
      }
    }}
  />
  ...
  {attendancePct !== null ? (
    <Box sx={{ px: 1 }}>
      <Box sx={{ display: "flex", justifyContent: "space-between", mb: 0.5 }}>
        ...
        <Typography sx={{
          fontSize: 13, fontWeight: 800,
          color: Number(attendancePct) >= 75 ? "#16a34a" : Number(attendancePct) >= 50 ? "#d97706" : "#dc2626",
        }}>
          {attendancePct}%
        </Typography>
      </Box>
      <Box sx={{ height: 8, background: "#e2e8f0", borderRadius: 4, overflow: "hidden" }}>
        <Box sx={{
          ...
          background: Number(attendancePct) >= 75 ? "#16a34a" : Number(attendancePct) >= 50 ? "#f59e0b" : "#dc2626",
          transition: "width 0.3s",
        }} />
      </Box>
      <Typography sx={{
...
<Box sx={{ border: "1px solid #e2e8f0", borderRadius: 2, p: 2, mb: 2, bgcolor: "#f8faff" }}>
  <Grid container spacing={2} alignItems="center">
    <Grid item xs={12} sm={4}>
      <TextField
        type="month" size="small" sx={{ minWidth: 220 }} fullWidth label="Month & Year"
        value={monthYear}
...
const absent  = Math.max(0, (Number(row.workingDays)||0) - present);
  ...
  const updateField = (field, val) =>
    setTeachRows((prev) => prev.map((r) => r.id === row.id ? { ...r, [field]: val } : r));
  ...
  return (
    <Box key={row.id} sx={{ border: "1px solid #e2e8f0", p: 2, borderRadius: 2, mb: 2 }}>
      ...
      <Grid container spacing={2}>
        <Grid item xs={12} md={3}>
          <TextField select fullWidth size="small" sx={{ minWidth: 220 }} label="Post"
            value={row.post}
       ...
       <Grid item xs={12} md={2}>
  <TextField fullWidth size="small" sx={{ minWidth: 220 }} label="Working Days" type="number"
...
/>
        ...
        <Grid item xs={12} md={2} sx={{ display: "flex", alignItems: "center" }}>
          {row.name && (() => {
            ...
            return (
              <Chip size="small" label={`${rate}% · ${label}`}
                sx={{ bgcolor: bg, color, fontWeight: 600, fontSize: 12 }} />
            );
          })()}
        </Grid>
        ...
        <Grid item xs={12} md={2} sx={{ textAlign: "right" }}>
          {teachRows.length > 1 && (
            <Button size="small" color="error" variant="outlined"
              onClick={() => setTeachRows((p) => p.filter((r) => r.id !== row.id))}>
              Remove
            </Button>
          )}
        </Grid>
      ...
      {/* leave details */}
      <Typography sx={{ fontWeight: 600, mt: 2, mb: 1, fontSize: 14 }}>
        📌 Leave Details
      </Typography>

      <Grid container spacing={2}>
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Casual Leave" type="number"
            value={row.cl}
            inputProps={{ min: 0 }}
        ...
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Earned Leave" type="number"
            value={row.el}
            inputProps={{ min: 0 }}
        ...
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Medical Leave" type="number"
            value={row.ml}
            inputProps={{ min: 0 }}
        ...
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Maternity/Paternity" type="number"
            value={row.mat}
            inputProps={{ min: 0 }}
        ...
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Present Days"
            value={present}
            InputProps={{
              readOnly: true,
        ...
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Absent Days"
            value={absent}
            InputProps={{
              readOnly: true,
...
const absent  = Math.max(0, (Number(row.workingDays)||0) - present);
  ...
  const updateField = (field, val) =>
    setNtRows((prev) => prev.map((r) => r.id === row.id ? { ...r, [field]: val } : r));
...
/>
        ...
        <Grid item xs={12} md={2} sx={{ textAlign: "right" }}>
          {ntRows.length > 1 && (
            <Button size="small" color="error" variant="outlined"
              onClick={() => setNtRows((p) => p.filter((r) => r.id !== row.id))}>
              Remove
            </Button>
          )}
        </Grid>
      ...
      <Grid container spacing={2}>
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Casual Leave" type="number"
            value={row.cl} inputProps={{ min: 0 }}
            onChange={(e) => updateField("cl", e.target.value)} />
        </Grid>
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Earned Leave" type="number"
            value={row.el} inputProps={{ min: 0 }}
            onChange={(e) => updateField("el", e.target.value)} />
        </Grid>
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Medical Leave" type="number"
            value={row.ml} inputProps={{ min: 0 }}
            onChange={(e) => updateField("ml", e.target.value)} />
        </Grid>
        <Grid item xs={6} md={2}>
          <TextField fullWidth size="small" label="Maternity/Paternity" type="number"
            value={row.mat} inputProps={{ min: 0 }}
            onChange={(e) => updateField("mat", e.target.value)} />
        </Grid>
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #e0e0e0', marginBottom: 16 }}>
    ...
    <tbody>
      {procurements.map((p, i) => {
        const rowPct = Number(p.totalNumber) > 0
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #e0e0e0' }}>
    ...
    <tbody>
      {[
        ...
        <tr key={i} style={{
          background: gemMarks === row.marks && procurements.length > 0 ? '#e8f5e9' : 'white'
        }}>
...
>
    ...
    <Grid container spacing={2} sx={{ mt: 0.5 }}>
      ...
      <Grid item xs={12}>
        <FormControl fullWidth size="small">
          ...
          <Select
            ...
            onChange={e => setCurrentProcurement(prev => ({ ...prev, type: e.target.value }))}
          >
      ...
      <Grid item xs={12}>
        <TextField
          ...
          onChange={e => setCurrentProcurement(prev => ({ ...prev, description: e.target.value }))}
        />
      </Grid>

      <Grid item xs={12} sm={6}>
        <TextField
          fullWidth size="small" label="Total Number of Procurements" type="number"
          value={currentProcurement.totalNumber}
          onChange={e => setCurrentProcurement(prev => ({ ...prev, totalNumber: e.target.value }))}
        />
      </Grid>

      <Grid item xs={12} sm={6}>
        <TextField
          fullWidth size="small" label="Procurement Order Date" type="date"
          InputLabelProps={{ shrink: true }}
          value={currentProcurement.orderDate}
          onChange={e => setCurrentProcurement(prev => ({ ...prev, orderDate: e.target.value }))}
        />
      </Grid>

      <Grid item xs={12} sm={6}>
        <TextField
          fullWidth size="small" label="Procurement Value (₹)" type="number"
          value={currentProcurement.value}
          onChange={e => setCurrentProcurement(prev => ({ ...prev, value: e.target.value }))}
        />
      </Grid>

      <Grid item xs={12} sm={6}>
        <TextField
          fullWidth size="small" label="Vendor"
          value={currentProcurement.vendor}
          onChange={e => setCurrentProcurement(prev => ({ ...prev, vendor: e.target.value }))}
        />
      </Grid>

      <Grid item xs={12}>
        <TextField
          fullWidth size="small" label="Procurement through GeM Portal (count)" type="number"
          value={currentProcurement.throughGem}
          onChange={e => setCurrentProcurement(prev => ({ ...prev, throughGem: e.target.value }))}
        />
      </Grid>
      ...
      {currentProcurement.totalNumber && currentProcurement.throughGem && (
        <Grid item xs={12}>
          <Typography variant="body2" sx={{ color: '#1976d2', fontWeight: 600 }}>
            GeM %: {((Number(currentProcurement.throughGem) / Number(currentProcurement.totalNumber)) * 100).toFixed(2)}%
            &nbsp;→&nbsp;
            Marks: {getGemMarks(((Number(currentProcurement.throughGem) / Number(currentProcurement.totalNumber)) * 100).toFixed(2))}
          </Typography>
        </Grid>
      )}
  ...
  <DialogActions sx={{ p: 2 }}>
    <Button
      onClick={() => {
        setCurrentProcurement({ type: '', description: '', totalNumber: '', orderDate: '', value: '', vendor: '', throughGem: '' });
  ...
  <TextField fullWidth size="small" label="Audit Conducted Annually" />
                  ...
                  <Grid item xs={12}>
                    ...
                    <table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #e0e0e0' }}>
                      ...
                      <tbody>
                        <tr>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>95% – 100%</td>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>5</td>
                        </tr>
                        <tr>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>70% – 94%</td>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>3</td>
                        </tr>
                        <tr>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>50% – 69%</td>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>1</td>
                        </tr>
                        <tr>
                          <td style={{ border: '1px solid #e0e0e0', padding: '8px' }}>Below 50%</td>
...
<table style={{ width: '100%', borderCollapse: 'collapse', border: '1px solid #e0e0e0', marginBottom: '24px' }}>
  <thead>
    <tr style={{ background: '#1976d2', color: '#fff' }}>
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'center', width: '50px' }}>S.No</th>
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'left' }}>Component</th>
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', width: '140px' }}>
        Max. Permissible Annual Expenditure per Student (w.e.f. 01.04.2025) (A)
      </th>
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', width: '150px' }}>
        Max. Permissible Annual Expenditure for FY 2025-26 for 300 Students as per MIS Portal (B) = (A) × 300
      </th>
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', width: '140px' }}>
      ...
      <th style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'left', width: '160px' }}>
        Remarks
      </th>
    </tr>
  </thead>
  <tbody>
    ...
    <tr style={{ background: '#e3f2fd' }}>
      ...
      <td style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', fontWeight: 'bold' }}>
        ₹{recurringBreakup.reduce((sum, r) => sum + (Number(r.colA) || 0), 0).toLocaleString('en-IN')}
      </td>
      <td style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', fontWeight: 'bold' }}>
        ₹{recurringBreakup.reduce((sum, r) => sum + ((Number(r.colA) || 0) * 300), 0).toLocaleString('en-IN')}
      </td>
      <td style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', fontWeight: 'bold' }}>
        ₹{recurringBreakup.reduce((sum, r) => sum + (Number(r.colC) || 0), 0).toLocaleString('en-IN')}
      </td>
      <td style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', fontWeight: 'bold' }}>
        ₹{recurringBreakup.reduce((sum, r) => sum + (Number(r.colD) || 0), 0).toLocaleString('en-IN')}
      </td>
      <td style={{ border: '1px solid #e0e0e0', padding: '8px', textAlign: 'right', fontWeight: 'bold' }}>
        ₹{recurringBreakup.reduce((sum, r) => sum + (Number(r.colE) || 0), 0).toLocaleString('en-IN')}
      </td>
